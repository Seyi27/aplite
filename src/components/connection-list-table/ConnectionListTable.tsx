...
const ConnectionListTable = () => {
  ...
  return (
    <div className="border-1 border-[#F1F1F1] bg-white mt-10 p-5 rounded-sm">
      ...
      {loading ? (
        ...
        <table className="sm:w-full text-left border-separate border-spacing-y-2 pt-3">
          <thead>
              ...
              >
                <td className="px-4 py-3">
                  <div className="flex items-center gap-2">
                    <div className="w-[20px] h-[20px] rounded-[30px] bg-[#111A4A] text-white font-bold flex items-center justify-center">
                      J
                    </div>
                    {req.name}
                  </div>
